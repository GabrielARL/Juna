#!/usr/bin/env python3
"""Validate the N=1024, CP=16, rate=0.125, pilots=3/10, K=fill result."""
...
EXPERIMENT_ID = (
    "2026-08-06-red-snr-sweep-n1024-cp16-rate0125-p3-10-dc10-kfill")
...
def main():
    ...
    caption = "N=1024 · CP=16 · rate=0.125 · pilots=3/10 · dc=10 · K=fill"
    for channel, lane in EXPECTED_PATHS:
    ...
    print("N1024 CP16 rate-0.125 pilots-3/10 K=fill validation passed: "
