#!/usr/bin/env python3
"""Validate N=1024, CP=16, rate=0.5, pilots=3/10, K=fill, PFFT=1."""
...
EXPERIMENT_ID = (
    "2026-08-07-red-snr-sweep-n1024-cp16-rate05-p3-10-dc12-kfill-pfft1")
...
EXPECTED_GEOMETRY = ("1024", "16", "0.5", "3", "10", "12", "0")
...
def require(condition, message):
    if not condition:
        raise SystemExit(
            "N1024 CP16 rate-0.5 pilots-3/10 K=fill validation failed: "
            + message)
...
def main():
    ...
    caption = ("N=1024 · CP=16 · rate=0.5 · pilots=3/10 · dc=12 · "
               "K=fill · PFFT parts=1")
    for channel, lane in EXPECTED_PATHS:
    ...
    print("N1024 CP16 rate-0.5 pilots-3/10 K=fill PFFT=1 validation passed: "
