#!/usr/bin/env python3
"""Validate the N=2048, CP=16, rate=0.25, pilots=3/5, K=4 result."""
...
EXPECTED_GEOMETRY = ("2048", "16", "0.25", "3", "5", "10", "4")
EXPECTED_PAYLOAD_BITS_PER_FRAME = 2160
...
def require(condition, message):
    if not condition:
        raise SystemExit("N2048 CP16 rate-0.25 K=4 validation failed: " + message)
...
def main():
    ...
    caption = "N=2048 · CP=16 · rate=0.25 · pilots=3/5 · dc=10 · K=4"
    for channel, lane in EXPECTED_PATHS:
    ...
    view_builder = os.path.join(
        ...
        "build_sweep_view.py")
    namespace = {"__file__": view_builder, "__name__": "_n2048_cp16_view"}
    ...
    print("N2048 CP16 rate-0.25 K=4 validation passed: "
