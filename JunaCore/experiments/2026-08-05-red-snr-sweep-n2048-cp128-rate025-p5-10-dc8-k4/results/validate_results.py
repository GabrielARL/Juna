#!/usr/bin/env python3
"""Validate the approved N=2048, rate-0.25, K=4 twelve-path SNR result."""
...
EXPECTED_GEOMETRY = ("2048", "128", "0.25", "5", "10", "8", "4")
...
EXPECTED_DECISIONS = {"CL-29", "CL-30", "CL-33", "CL-36", "CL-38", "CL-41"}
N512_HASHES = {
...
N1024_HASHES = {
    "red_snr_sweep_uwa_noise.csv":
        "ed1cbd98c42756a7d20f8988182e6b3ebaf9493a60d6b1d213ee95e062e0276d",
    "results_manifest.json":
        "0703e8aa405e7c0a8f279adbc9761bcbc1d9a8779bb0f31f446e9285a9098871",
    "results_view.html":
        "a3fb6de667a53d850d54ba16b72d6f066ac2a4f67c8983915bbd7722448b5128",
}
...
def require(condition, message):
    if not condition:
        raise SystemExit(
            "N2048 rate-0.25 fixed-configuration validation failed: " + message)
...
def main():
    ...
    caption = "N=2048 · CP=128 · rate=0.25 · pilots=5/10 · dc=8 · K=4"
    for channel, lane in EXPECTED_PATHS:
    ...
    view_builder = os.path.join(
        ...
        "build_sweep_view.py")
    namespace = {"__file__": view_builder, "__name__": "_n2048_rate025_view_builder"}
    ...
    print("N2048 rate-0.25 fixed-configuration validation passed: "
