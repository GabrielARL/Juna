#!/usr/bin/env python3
"""Validate the approved N=2048, K=4 twelve-path SNR result."""
...
EXPECTED_GEOMETRY = ("2048", "128", "0.5", "5", "10", "8", "4")
...
def require(condition, message):
    if not condition:
        raise SystemExit("N2048 fixed-configuration validation failed: " + message)
...
def main():
    ...
    for row in rows:
        ...
        require(int(row["payload_bits_per_frame"]) == 5859,
    ...
    caption = "N=2048 · CP=128 · rate=0.5 · pilots=5/10 · dc=8 · K=4"
    for channel, lane in EXPECTED_PATHS:
    ...
    namespace = {"__file__": view_builder, "__name__": "_n2048_view_builder"}
    ...
    print("N2048 fixed-configuration validation passed: 960 aggregate rows, "
