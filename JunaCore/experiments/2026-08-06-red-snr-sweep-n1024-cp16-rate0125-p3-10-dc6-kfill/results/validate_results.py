...
EXPERIMENT_ID = (
    "2026-08-06-red-snr-sweep-n1024-cp16-rate0125-p3-10-dc6-kfill")
...
EXPECTED_GEOMETRY = ("1024", "16", "0.125", "3", "10", "6", "0")
...
def main():
    ...
    caption = "N=1024 · CP=16 · rate=0.125 · pilots=3/10 · dc=6 · K=fill"
    for channel, lane in EXPECTED_PATHS:
