#!/usr/bin/env python3
"""Validate N=1024, CP=16, rate=0.125, pilots=3/5, K=fill, PFFT=1."""
...
EXPERIMENT_ID = (
    "2026-08-06-red-snr-sweep-n1024-cp16-rate0125-p3-5-dc10-kfill-pfft1")
...
EXPECTED_GEOMETRY = ("1024", "16", "0.125", "3", "5", "10", "0")
EXPECTED_PAYLOAD_BITS_PER_FRAME = 664
...
def require(condition, message):
    if not condition:
        raise SystemExit(
            "N1024 CP16 rate-0.125 pilots-3/5 K=fill validation failed: "
            + message)
...
def main():
    ...
    caption = ("N=1024 · CP=16 · rate=0.125 · pilots=3/5 · dc=10 · "
               "K=fill · PFFT parts=1")
    for channel, lane in EXPECTED_PATHS:
    ...
    namespace = {"__file__": view_builder,
                 "__name__": "_n1024_cp16_rate0125_p3_5_view"}
    ...
    print("N1024 CP16 rate-0.125 pilots-3/5 K=fill PFFT=1 validation passed: "
