...
EXPERIMENT_ID = (
    "2026-08-06-red-snr-sweep-n1024-cp128-rate0125-p5-10-dc6-kfill")
...
EXPECTED_GEOMETRY = ("1024", "128", "0.125", "5", "10", "6", "0")
...
def main():
    ...
    caption = "N=1024 · CP=128 · rate=0.125 · pilots=5/10 · dc=6 · K=fill"
    for channel, lane in EXPECTED_PATHS:
