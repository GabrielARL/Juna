#!/usr/bin/env python3
"""Approved AWGN-023B geometry and result-shape contract."""
...
SNAPSHOT_INDICES = (
    ...
    3073, 3168, 3262, 3357, 3457, 3552, 3646, 3741,
    3841, 3936, 4030, 4125, 4225, 4320, 4414,
)
...
class MatrixContractError(RuntimeError):
    """The approved AWGN-023B matrix shape was not met."""
...
def parse_geometry(experiment_id):
    ...
    if match is None:
        raise MatrixContractError(
            "unexpected AWGN-023B experiment ID: " + experiment_id
        )
...
def validate_source_contract(payload):
    ...
    if (payload.get("payload_bits_per_frame") != 1616
            or payload.get("payload_bits_per_point") != 75952):
...
if __name__ == "__main__":
    validate_ids()
    print(
        "AWGN-023B MATRIX CONTRACT PASS: 1 configuration, 12 paths, "
