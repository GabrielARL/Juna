# Cross-repository decision parity, keyed by receiver and scenario.
#
# The committed golden file was generated by running this script under the
# pinned sonique source commit named in tools/explorer/receivers.json. CI runs
# standalone against those immutable digests; adding a receiver adds keys and
# never invalidates evidence for an existing receiver.
