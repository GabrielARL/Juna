...
principle to Partial-FFT reception and carry it one step further.  Rather than pass information between two fitted stages, we place three
...
channel parameters \(\bm\psi\).  The next section supplies the first two
for OFDM under residual Doppler.  The section after it names
...
connects them to the relaxed symbols, and names the channel parameters that
the receivers estimate.
