...
popular choice, and the one we use here, is a low-density parity-check (LDPC)
block code.  The parity constraints of the code couple every coded carrier in
the codeword, and they are the only constraints in the receiver that do so;
pilots constrain their own carriers and their neighbours.
